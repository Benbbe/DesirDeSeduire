<?php /* Smarty version Smarty-3.1.19, created on 2017-02-05 21:38:09
         compiled from "E:\dev\servers\xampp\htdocs\underwears\themes\milan\product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2304158978d3118bd07-29075929%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ff6f2561b178c7ca8fe911425a48d143bad2763' => 
    array (
      0 => 'E:\\dev\\servers\\xampp\\htdocs\\underwears\\themes\\milan\\product-list.tpl',
      1 => 1486326784,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2304158978d3118bd07-29075929',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58978d3133f6a1_67306518',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58978d3133f6a1_67306518')) {function content_58978d3133f6a1_67306518($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include 'E:\\dev\\servers\\xampp\\htdocs\\underwears\\tools\\smarty\\plugins\\function.math.php';
?>
...
?>
		...
		<div data-product-id="<?php echo $_smarty_tpl->tpl_vars['product']->value['id_product'];?>
" class="col-sm-6 pl-item ajax_block_product<?php if ($_smarty_tpl->tpl_vars['page_name']->value=='index'||$_smarty_tpl->tpl_vars['page_name']->value=='product') {?> col-md-3 pl-item<?php } else { ?> col-md-4 pl-item<?php }?>">
...
" itemprop="url">
                        <?php if (isset($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']])&&!empty($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']])) {?>
                            <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],(($_smarty_tpl->tpl_vars['product']->value['id_product']).("-")).($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']][0]['id_image']),'home_default'), ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>" itemprop="image" />
                            <?php if (isset($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']][1])&&!empty($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']][1])) {?>
                                <span class="pl-backside">
                                    <img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],(($_smarty_tpl->tpl_vars['product']->value['id_product']).("-")).($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']][1]['id_image']),'home_default'), ENT_QUOTES, 'UTF-8', true);?>
" alt="<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['legend'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" title="<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['legend'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>"  itemprop="image" />
                    ...
                    <?php if (isset($_smarty_tpl->tpl_vars['product']->value['new'])&&$_smarty_tpl->tpl_vars['product']->value['new']==1) {?>
                        <label class="pl-badge-new"><?php echo smartyTranslate(array('s'=>'New'),$_smarty_tpl);?>
</label>
                    <?php }?>
                    <?php if (isset($_smarty_tpl->tpl_vars['product']->value['on_sale'])&&$_smarty_tpl->tpl_vars['product']->value['on_sale']&&isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
                        <label class="pl-badge-sale"><?php echo smartyTranslate(array('s'=>'Sale!'),$_smarty_tpl);?>
</label>
                    <?php } elseif (isset($_smarty_tpl->tpl_vars['product']->value['reduction'])&&$_smarty_tpl->tpl_vars['product']->value['reduction']&&isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
                        <span class="pl-badge-sale"><?php echo smartyTranslate(array('s'=>'Reduced price!'),$_smarty_tpl);?>
</span>
                    <?php }?>
                    <figcaption>
...
" rel="nofollow" data-id-product="<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
"><i class="icon-bag"></i> <span><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
</span></a>
                                <?php } else { ?>
...
"><i class="icon-bag"></i> <span><?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars['quick_view']->value)&&$_smarty_tpl->tpl_vars['quick_view']->value) {?>
                            <?php if ((isset($_smarty_tpl->tpl_vars['milan_settings']->value)&&$_smarty_tpl->tpl_vars['milan_settings']->value['quick_view_popup']&&$_smarty_tpl->tpl_vars['milan_settings']->value['product_list_show_quick_view_button'])||!isset($_smarty_tpl->tpl_vars['milan_settings']->value)) {?>
                                <a class="pl-button pl-qview quick-view" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['link'], ENT_QUOTES, 'UTF-8', true);?>
...
"><i class="icon-eye"></i></a>
                            <?php }?>
                        <?php }?>
                        <?php if (((isset($_smarty_tpl->tpl_vars['milan_settings']->value)&&$_smarty_tpl->tpl_vars['milan_settings']->value['product_list_show_compare_button'])||!isset($_smarty_tpl->tpl_vars['milan_settings']->value))) {?>
...
"><i class="arrow_left-right_alt"></i> <span><?php echo smartyTranslate(array('s'=>'Add to Compare'),$_smarty_tpl);?>
</span></a>
                            <?php }?>
                        <?php }?>
                ...
                <div class="plv-exerpt">
                    <?php echo strip_tags($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['description_short'],200,'...'));?>
                    ...
                    <div class="col-xs-6 plv-availability"><span class="plva-label">Availability:</span>
                        <?php if ((!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&$_smarty_tpl->tpl_vars['PS_STOCK_MANAGEMENT']->value&&((isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price'])||(isset($_smarty_tpl->tpl_vars['product']->value['available_for_order'])&&$_smarty_tpl->tpl_vars['product']->value['available_for_order'])))) {?>
                           <?php if (isset($_smarty_tpl->tpl_vars['product']->value['available_for_order'])&&$_smarty_tpl->tpl_vars['product']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
                               <span itemprop="offers" itemscope itemtype="http://schema.org/Offer" class="stock-status <?php if ($_smarty_tpl->tpl_vars['product']->value['quantity']<=0) {?>out-stock-lbl<?php } else { ?>in-stock-lbl<?php }?>">
                                   <?php if (($_smarty_tpl->tpl_vars['product']->value['allow_oosp']||$_smarty_tpl->tpl_vars['product']->value['quantity']>0)) {?>
                                       <link itemprop="availability" href="http://schema.org/InStock" />
                                           <?php if ($_smarty_tpl->tpl_vars['product']->value['quantity']<=0) {?>
                                               <?php if ($_smarty_tpl->tpl_vars['product']->value['allow_oosp']) {?>
                                                   ...
                                                   <?php } else { ?>
                                                       <i class="dot-green"></i> <?php echo smartyTranslate(array('s'=>'In Stock'),$_smarty_tpl);?>

                                                   <?php }?>
                                               <?php } else { ?>
                                                   <i class="dot-grey"></i> <?php echo smartyTranslate(array('s'=>'Out of stock'),$_smarty_tpl);?>

                                               <?php }?>
                                           <?php } else { ?>
                                               <?php if (isset($_smarty_tpl->tpl_vars['product']->value['available_now'])&&$_smarty_tpl->tpl_vars['product']->value['available_now']) {?>
                                                   <i class="dot-green"></i> <?php echo $_smarty_tpl->tpl_vars['product']->value['available_now'];?>
                                   ...
                                   <?php } else { ?>
                                       <link itemprop="availability" href="http://schema.org/OutOfStock" /><i class="dot-grey"></i> <?php echo smartyTranslate(array('s'=>'Out of stock'),$_smarty_tpl);?>
                    ...
                    <?php if ((!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&((isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price'])||(isset($_smarty_tpl->tpl_vars['product']->value['available_for_order'])&&$_smarty_tpl->tpl_vars['product']->value['available_for_order'])))) {?>
                        <p class="pl-price-block" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                            <?php if (isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
                                <span itemprop="price" class="pl-price product-price"><?php if (!$_smarty_tpl->tpl_vars['priceDisplay']->value) {?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value['price']),$_smarty_tpl);?>
...
" />
                                <?php if (isset($_smarty_tpl->tpl_vars['product']->value['specific_prices'])&&$_smarty_tpl->tpl_vars['product']->value['specific_prices']&&isset($_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction'])&&$_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction']>0) {?>
                                    ...
                                    <span class="pl-price-old product-price"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['displayWtPrice'][0][0]->displayWtPrice(array('p'=>$_smarty_tpl->tpl_vars['product']->value['price_without_reduction']),$_smarty_tpl);?>
</span>
                                    <?php if ($_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction_type']=='percentage') {?><span class="pl-discount-percent">-<?php echo $_smarty_tpl->tpl_vars['product']->value['specific_prices']['reduction']*100;?>
%</span>
                                    <?php }?>
                                <?php }?>
...
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
" itemprop="url" >
                        <p class="pl-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
</p>
                    </a>
