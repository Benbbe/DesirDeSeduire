					...
					<div class="row"> 
						...
						<div class="right-side col-xs-12 col-sm-4">
			            	<div class="right-side-content">
			                    ...
			                    {if $supplier.nb_products > 0}
			                        <a class="btn btn-sec-col" href="{$link->getsupplierLink($supplier.id_supplier, $supplier.link_rewrite)|escape:'html':'UTF-8'}"><span>{l s='View products'} <i class="icon-chevron-right right"></i></span></a>
			                    {/if}
			                </div>
						</div><!-- .right-side -->
					</div>
