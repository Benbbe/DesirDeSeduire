...
{capture name=pageTitle}{l s='Guest Tracking'}{/capture}
<div class="container">
    <div class="row">
	...
	{else}
		<form method="post" action="{$action|escape:'html':'UTF-8'}#guestToCustomer" class="std">
			<fieldset class="description_box box">
                ...
                <div class="row">
                	<div class="col-xs-12 col-sm-5 col-md-4 col-lg-3">
                        <div class="text form-group">
                            <label class="type-text">{l s='Set your password:'}
				...
				<p>
                    <button type="submit" name="submitTransformGuestToCustomer" class="button btn-sec-col button-medium btn"><span>{l s='Send'}<i class="icon-chevron-right right"></i></span></button>
                </p>
			</fieldset>
		</form>
	{/if}
	...
	<form method="post" action="{$action|escape:'html':'UTF-8'}" class="std" id="guestTracking">
		<fieldset class="description_box box">
			<h2 class="page-subheading">{l s='To track your order, please enter the following information:'}</h2>
                    <div class="text form-group">
                        <label class="type-text">{l s='Order Reference:'} 
                    ...
                    <div class="text form-group">
                        <label class="type-text">{l s='Email:'}
            ...
            <p>
                <button type="submit" name="submitGuestTracking" class="button btn-sec-col btn btn-default button-medium"><span>{l s='Send'}<i class="icon-chevron-right right"></i></span></button>
            </p>
		</fieldset>
	</form>
{/if}
