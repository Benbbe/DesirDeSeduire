                ...
                <div class="col-md-10 col-sm-12 col-xs-12">
                    ...
                    <div class="addresses">
                            ...
                            <div class="col-xs-12 col-sm-6 address">
                                <ul class="list-unstyled {if $smarty.foreach.myLoop.last}last_item{elseif $smarty.foreach.myLoop.first}first_item{/if} {if $smarty.foreach.myLoop.index % 2}alternate_item{else}item{/if} box">
                                    ...
                                    <a class="btn btn-sm btn-prim-col" 
                                       href="{$link->getPageLink('address', true, null, "id_address={$address.object.id|intval}")|escape:'html':'UTF-8'}" title="{l s='Update'}">
                                        <span data-icon="&#x6a;"> {l s='Update'}</span>
                                    </a>
                                    <a class="btn btn-sm btn-prim-col" 
                                       href="{$link->getPageLink('address', true, null, "id_address={$address.object.id|intval}&delete")|escape:'html':'UTF-8'}" 
                                       onclick="return confirm('{l s='Are you sure?' js=1}');" title="{l s='Delete'}">
                                        <span  data-icon="&#xe019;"> {l s='Delete'}</span>
                                    </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    {else}
                        <div class="alert alert-warning">
                            <div>
                                {l s='No addresses are available.'}&nbsp;<a href="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}">{l s='Add a new address'}</a>
                            </div>
                        </div>
                    {/if}
                    <div class="clearfix main-page-indent">
                        <a href="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" title="{l s='Add an address'}" 
                           class="btn btn-yet-col"><span data-icon="&#x50;"> {l s='Add a new address'}</span></a>
                    </div>
