	...
	<fieldset>
		<div class="box">
			...
			<div class="form-group">
					...
					<input type="text" class="form-control" name="customer_name" id="customer_name" value="{$customerName|escape:'html':'UTF-8'}" readonly />
				</div>
			<div class="form-group">
		...
		<p class="cart_navigation required submit clearfix">
			...
			{if $is_16}
			<button type="submit" class="button btn btn-third-col btn-sm" name="submitNewComment" id="submitNewComment">
				<span>
