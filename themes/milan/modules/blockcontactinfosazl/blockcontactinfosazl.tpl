...
<div class="col-md-4">
    <div class="contact-info-box mobile-collapse">
        ...
        <ul class="list-unstyled mobile-collapse-body">
            ...
            {if $blockcontactinfosazl_phone != ''}<li><span><i class="icon-screen-smartphone"></i></span><span>{$blockcontactinfosazl_phone|escape:'html':'UTF-8'}</span></li>{/if}
            {if $blockcontactinfosazl_email != ''}<li><span><i class="icon-envelope "></i></span><span>{mailto address=$blockcontactinfosazl_email|escape:'html':'UTF-8' encode="hex"}</span></li>{/if}
        </ul>
    </div>
</div>
<!-- /MODULE Block contact infos -->
