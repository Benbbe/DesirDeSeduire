	...
	<!-- Pagination -->
		...
		{if $start!=$stop}
			<ul class="pagination">
				...
				{else}
					<li id="pagination_previous{if isset($paginationId)}_{$paginationId}{/if}" class="hidden pagination_previous">
						<span>
							<i class="arrow_carrot-left"></i>
						</span>
					</li>
				...
				{else}
					<li id="pagination_next{if isset($paginationId)}_{$paginationId}{/if}" class="hidden pagination_next">
						<span>
							<i class="arrow_carrot-right"></i>
						</span>
					</li>
