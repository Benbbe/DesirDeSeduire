...
{capture name=pageTitle}{l s='My vouchers'}{/capture}
<div class="container">
    <div class="row">
        <div class="container">
     ...
     <div class="row">
        <div class="col-xs-12 col-md-2 left-menu">
            {hook h="displayMyAccountLeft" active='discount'}
        </div>
        <div class="col-md-10 col-sm-12 col-xs-12">
            {if isset($cart_rules) && count($cart_rules) && $nb_cart_rules}
                <div class="table-container">
                    <table class="discount table table-bordered footab resp-tbl">
                            <thead>
                                    <tr>
                                    ...
                                    {foreach from=$cart_rules item=discountDetail name=myLoop}
                                            <tr class="{if $smarty.foreach.myLoop.first}first_item{elseif $smarty.foreach.myLoop.last}last_item{else}item{/if} {if $smarty.foreach.myLoop.index % 2}alternate_item{/if}">
                                                    <td class="discount_code">
                                                        <div class="resp-tbl-head">{l s='Code'}</div>
                                                        <div class="resp-tbl-cnt">
                                                            {$discountDetail.code}
                                                        </div>
                                                    </td>
                                                    <td class="discount_description">
                                                        <div class="resp-tbl-head">{l s='Description'}</div>
                                                        <div class="resp-tbl-cnt">
                                                        {$discountDetail.name}
                                                        </div>
                                                    </td>
                                                    <td data-value="{$discountDetail.quantity_for_user}" class="discount_quantity">
                                                    ...
                                                    <td class="discount_value">
                                                        <div class="resp-tbl-head">{l s='Value'}*</div>
                                                        <div class="resp-tbl-cnt">
                                                    ...
                                                    <td class="discount_minimum" data-value="{if $discountDetail.minimal == 0}0{else}{$discountDetail.minimal}{/if}">
                                                        <div class="resp-tbl-head">{l s='Minimum'}</div>
                                                        <div class="resp-tbl-cnt">
                                                    ...
                                                    <td class="discount_cumulative">
                                                        <div class="resp-tbl-head">{l s='Cumulative'}</div>
                                                        <div class="resp-tbl-cnt">
                                                    ...
                                                    <td class="discount_expiration_date" data-value="{$discountDetail.date_to|regex_replace:"/[\-\:\ ]/":""}">
                                                        <div class="resp-tbl-head">{l s='Expiration date'}</div>
                                                        <div class="resp-tbl-cnt">
