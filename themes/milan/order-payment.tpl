...
<div class="row">
    ...
    <div class="col-sm-6">
        <a href="{$link->getPageLink('order', true, NULL, "step=2")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button-exclusive btn-md btn btn-default">
