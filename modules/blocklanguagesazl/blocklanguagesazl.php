...
class BlockLanguagesAzl extends Module
{
    public function __construct()
    {
        $this->name = 'blocklanguagesazl';
    ...
    {
        return (parent::install() && $this->registerHook('displayNavLeft') /*&& $this->registerHook('displayHeader')*/);
    }
    ...
    public function hookDisplayTop($params)
    {
        ...
        return $this->display(
            __FILE__,
            'views/templates/hook/blocklanguagesazl.tpl'
        );
    }
    ...
    private function prepareHook()
    {
        ...
        if ((int)Configuration::get('PS_REWRITING_SETTINGS')) {
            ...
            if (Dispatcher::getInstance()->getController() == 'cms'
                ...
                $rewrite_infos = (isset($id_cms) && !isset($id_cms_category)) ?
                    CMS::getUrlRewriteInformations($id_cms) : CMSCategory::getUrlRewriteInformations($id_cms_category);
                foreach ($rewrite_infos as $infos) {
                    $arr_link = (isset($id_cms) && !isset($id_cms_category)) ? $link->getCMSLink(
                        $id_cms,
                        $infos['link_rewrite'],
                        null,
                        $infos['id_lang']
