...
class BlockWishlistAzl extends Module
{
    public function __construct()
    {
        $this->name = 'blockwishlistazl';
        ...
        $this->description = $this->l('Popup wishlist block module');
    ...
    public function hookDisplayTop($params)
    {
        ...
        if ($context->customer->isLogged()) {
            ...
            return $this->display(
                __FILE__,
                'views/templates/hook/blockwishlistazl.tpl'
            );
        }
    }
    ...
    {
        $this->context->controller->addJS(($this->_path).'views/js/blockwishlistazl.js');
    }
}
