...
class CompareAzl extends ObjectModel
{
    /**
    ...
    public static $definition
        = array(
            'table' => 'compare', 'primary' => 'id_compare', 'fields' => array(
    ...
    public static function addCompareProduct($id_compare, $id_product)
    {
        ...
        if (!$id_compare) {
            ...
            $sql = Db::getInstance()->execute(
                '
			INSERT INTO `'._DB_PREFIX_.'compare` (`id_compare`, `id_customer`) VALUES (NULL, "'.($id_customer ?
                    $id_customer : '0').'")'
            );
            if ($sql) {
