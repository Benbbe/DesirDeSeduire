...
class BlockManufacturerAzl extends Module
{
    public function __construct()
    {
        $this->name = 'blockmanufacturerazl';
        ...
        $this->displayName = $this->l('Manufacturers block Azelab');
    ...
    public function install()
    {
        ...
        if ($success) {
            ...
            if (!$this->registerHook('displayFooterColumn')) {
    ...
    public function hookdisplayFooterColumn($params)
    {
        if (!$this->isCached(
            ...
            foreach ($manufacturers as &$manufacturer) {
                ...
                if (file_exists(
                    _PS_MANU_IMG_DIR_.$manufacturer['id_manufacturer'].'-'.ImageType::getFormatedName('medium').'.jpg'
                )) {
        ...
        return $this->display(
            __FILE__,
            'views/templates/hook/blockmanufacturerazl.tpl',
            $this->getCacheId()
        );
    }
    ...
    {
        $this->_clearCache('blockmanufacturerazl.tpl');
    }
    ...
    {
        return array(
            'MANUFACTURER_DISPLAY_TEXT_NB' => Tools::getValue(
                'MANUFACTURER_DISPLAY_TEXT_NB',
                Configuration::get('MANUFACTURER_DISPLAY_TEXT_NB')
            ),
        );
    }
}
